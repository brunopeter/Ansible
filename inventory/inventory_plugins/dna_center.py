...
class InventoryModule(BaseInventoryPlugin, Constructable):
    ...
    def _add_hosts(self):
        ...
        for h in self._host_list: 
            ...
            ### if site_name:
            ### group_name = self.inventory.add_group(site_name)
            ...
            if isinstance(h.get('os'), str) and h['os'].lower() in ['ios', 'ios-xe', 'unified ap']:
            ...
            elif isinstance(h.get('os'), str) and h['os'].lower() in ['nxos','nx-os']:
